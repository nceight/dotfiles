...
if not present_cmp_nvim_lsp then
    return
end
...
local function lsp_keymaps(bufnr)
    ...
    keymap(bufnr, "n", "dv", "<CMD>lua vim.diagnostic.open_float()<CR>", opts)
...
M.on_attach = function(client, bufnr)
    ...
    local present_illuminate, illuminate = pcall(require, "illuminate")

    if not present_illuminate then
        return
    end
